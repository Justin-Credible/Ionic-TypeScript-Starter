...
module.exports = function(gulp: gulp.Gulp, plugins: GulpPlugins): TaskFunc {
    ...
    return function(cb) {
        ...
        runSequence("config", function (err) {
            ...
            let schemeName = helper.getCurrentSchemeName();

            helper.info("Generating: build/web/index.html from: resources/web/index.master.html");
            helper.performVariableReplacement(schemeName, "resources/web/index.master.html", "build/web/index.html");

            helper.info("Adding app bundle resource references to: build/web/index.html");
