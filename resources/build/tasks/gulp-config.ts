...
module.exports = function(gulp: gulp.Gulp, plugins: GulpPlugins): TaskFunc {
    ...
    return function (cb) {
        ...
        helper.info(`Configuring application with scheme: ${schemeName}`);
        ...
        if (helper.isPrepWeb()) {
            ...
            helper.info("Generating: build/web/manifest.json from: resources/web/manifest.master.json");
            helper.performVariableReplacement(schemeName, "resources/web/manifest.master.json", "build/web/manifest.json");

            helper.info("Generating: build/web/browserconfig.xml from: resources/web/browserconfig.master.xml");
            helper.performVariableReplacement(schemeName, "resources/web/browserconfig.master.xml", "build/web/browserconfig.xml");

            helper.info("Generating: www/index.html from: resources/web/index.master.html");
            ...
            helper.info("Generating: build/chrome/manifest.json from: resources/chrome/manifest.master.json");
            helper.performVariableReplacement(schemeName, "resources/chrome/manifest.master.json", "build/chrome/manifest.json");

            helper.info("Generating: www/index.html from resources/chrome/index.master.html");
            helper.performVariableReplacement(schemeName, "resources/chrome/index.master.html", "www/index.html");

            helper.info("Adding resource references to: www/index.html using: resources/chrome/index.references.yml");
            ...
            helper.info("Generating: config.xml from: resources/cordova/config.master.xml");
            helper.performVariableReplacement(schemeName, "resources/cordova/config.master.xml", "config.xml");

            helper.info("Generating: www/index.html from: resources/cordova/index.master.html");
            helper.performVariableReplacement(schemeName, "resources/cordova/index.master.html", "www/index.html");

            helper.info("Adding resource references to: www/index.html using: resources/cordova/index.references.yml");
            helper.performReferenceReplacement("www/index.html", "www/index.html", false, null, "resources/cordova/index.references.yml");
        }

        helper.info("Generating runtime configuration at: www/js/build-vars.js using: resources/config/config.yml");
